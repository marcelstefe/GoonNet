...
public class AppSettings
{
    ...
    public string ThrottleSensitivity { get; set; } = "5%";
    public string FoggerPower { get; set; } = "50%";
...
public static class SettingsService
{
    private static readonly string Dir =
        Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "AeroVisApp");
